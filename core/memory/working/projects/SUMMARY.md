...
| ---------------------- | --------- | ----------- | ------- | ------------------------------------------------------------------------------------------------------------------------ | ------------- |
| multi-user-support     | active    | planning    | 12      | Highest-priority active project: continue `concurrent-session-writes`, beginning with repo-common publication locking for linked worktrees. | 2026-04-15    |
