...
| ---------------------- | --------- | ----------- | ------- | ------------------------------------------------------------------------------------------------------------------------ | ------------- |
| multi-user-support     | active    | planning    | 12      | Highest-priority active project: start user identity resolution via `user-identity-and-namespacing` `env-identity`.    | 2026-04-15    |
