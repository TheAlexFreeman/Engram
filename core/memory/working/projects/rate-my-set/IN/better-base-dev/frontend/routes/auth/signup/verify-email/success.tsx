...
export const Route = createFileRoute('/auth/signup/verify-email/success')({
  loader: signUpVerifyEmailSuccessLoader,
  component: SignupVerifyEmailSuccess,
});

function signUpVerifyEmailSuccessLoader() {
...
function SignupVerifyEmailSuccess() {
  const redirectTo = '/auth/signup/complete';
