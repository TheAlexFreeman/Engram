...
The catalog is generated by scanning `core/memory/skills/*/SKILL.md` and extracting frontmatter. See `HUMANS/tooling/src/skill-catalog.js` (once implemented) for the programmatic generator.
